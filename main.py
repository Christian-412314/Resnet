...
def parse_command():
    ...
    parser.add_argument("--cfg", default=r'C:\Users\user\PycharmProjects\LMP1210 group project new\MultiHem-main\config.yml', type=str, help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
